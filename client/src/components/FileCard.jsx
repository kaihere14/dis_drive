    ...
    >
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-slate-50 text-slate-600 rounded-xl text-xs font-bold hover:bg-indigo-600 hover:text-white transition-all duration-200 flex items-center gap-2"
        >
